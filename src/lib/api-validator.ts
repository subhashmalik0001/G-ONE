...
export class APIValidator {
  private static readonly API_KEY = import.meta.env.VITE_GOOGLE_AI_STUDIO_KEY || import.meta.env.VITE_GEMINI_TEXT_KEY;
  private static readonly BASE_URL = 'https://generativelanguage.googleapis.com/v1beta/models/gemini-3-flash-preview:generateContent';
